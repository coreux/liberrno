...
#ifndef __UX_OPENBSD_ERRNO_H
# define __UX_OPENBSD_ERRNO_H          1

# ifndef __OpenBSD__
#  error Compilation of this file is only supported on OpenBSD
# endif
...
# define ENOMSG                        90  /* No message of the desired type. */
