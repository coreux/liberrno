...
# define EBADMSG                       170 /* Bad message. */
# define EBUSY                         16  /* Device or resource busy. */
# define ECANCELED                     153 /* Operation canceled. */
# define ECHILD                        10  /* No child processes. */
# define ECONNABORTED                  83  /* Connection aborted. */
...
# define EDQUOT                        177 /* Reserved. */
# define EEXIST                        17  /* File exists. */
# define EFAULT                        14  /* Bad address. */
# define EFBIG                         27  /* File too large. */
# define EHOSTUNREACH                  56  /* Host is unreachable. */
...
# define EMULTIHOP                     180 /* Reserved. */
# define ENAMETOOLONG                  36  /* Filename too long. */
# define ENETDOWN                      77  /* Network is down. */
# define ENETRESET                     81  /* Connection aborted by network. */
...
# define ENODATA                       190 /* No message is available on the STREAM head read queue. */
# define ENODEV                        19  /* No such device. */
# define ENOENT                        2   /* No such file or directory. */
# define ENOEXEC                       8   /* Executable file format error. */
# define ENOLCK                        37  /* No locks available. */
# define ENOLINK                       181 /* Reserved. */
# define ENOMEM                        12  /* Not enough space. */
# define ENOMSG                        45  /* No message of the desired type. */
# define ENOPROTOOPT                   75  /* Protocol not available. */
# define ENOSPC                        28  /* No space left on device. */
# define ENOSR                         191 /* No STREAM resources. */
# define ENOSTR                        192 /* Not a STREAM. */
...
# define ENOTSUP                       76  /* Not supported. */
# define ENOTTY                        25  /* Inappropriate I/O control operation. */
# define ENXIO                         6   /* No such device or address. */
# define EOPNOTSUPP                    76  /* Operation not supported on socket. */
# define EOVERFLOW                     46  /* Value too large to be stored in data type. */
# define EPERM                         1   /* Operation not permitted. */
# define EPIPE                         32  /* Broken pipe. */
# define EPROTO                        182 /* Protocol error. */
...
# define ESTALE                        160 /* Reserved. */
# define ETIME                         193 /* Stream ioctl() timeout. */
