...
#ifndef __UX_NETBSD_ERRNO_H
# define __UX_NETBSD_ERRNO_H           1

# ifndef __NetBSD__
#  error Compilation of this file is only supported on NetBSD
# endif
...
# define ENODATA                       89  /* No message is available on the STREAM head read queue. */
# define ENODEV                        19  /* No such device. */
# define ENOENT                        2   /* No such file or directory. */
# define ENOEXEC                       8   /* Executable file format error. */
# define ENOLCK                        77  /* No locks available. */
# define ENOLINK                       95  /* Reserved. */
